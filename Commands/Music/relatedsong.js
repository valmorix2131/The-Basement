...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        try{
            ...
            return interaction.reply({ embeds: [new MessageEmbed().setColor('#00ffe4').setDescription(`<a:animated_check:902802437646221313> **A Related Song has been added to the queue.**`)]});
